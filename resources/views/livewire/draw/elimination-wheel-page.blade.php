<div class="min-h-screen bg-gradient-to-br from-slate-100 via-white to-orange-50 px-4 py-8" x-data="
    {
        busy:false,
        autoMode:@entangle('autoMode').live
    }
    " x-on:wheel-spin.window="
        busy=true
    " x-on:wheel-spin-finished.window="
        busy=false;
        $wire.confirmElimination()
    " x-on:elimination-confirmed.window="
    ...
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
            ...
            <div class="flex gap-3">
                ...
                <div class="
                    ...
                    <div class="text-xs text-red-400 uppercase">
                        Sorties
                    </div>
        ...
        <div class="grid lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <button wire:click="$set('autoMode',false)" class="
                            w-full
                            rounded-2xl
                            py-4
                            font-black
                ...
                <button wire:click="handleAction" x-bind:disabled="busy" class="
                            w-full
                            rounded-2xl
                            py-4
                            font-black
                ...
                <button wire:click="restart" class="
                        w-full
                        rounded-2xl
                        border
                        bg-white
