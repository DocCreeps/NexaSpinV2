<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/50 relative overflow-hidden antialiased pb-24 selection:bg-indigo-500 selection:text-white" x-data="{
         spinning: false,
         finished: false
        ...
        <div class="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-7">
                <div class="bg-white rounded-3xl shadow-sm border border-slate-200/50 p-8 flex flex-col items-center min-h-[520px] justify-center">
                    ...
                    <div class="relative" wire:key="wheel-wrapper">
                        ...
                        <div class="absolute inset-0 bg-indigo-400/10 blur-3xl rounded-full"></div>
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-slate-200/50 p-5 overflow-hidden">
                    ...
                    <x-draw.participant-form :participants="$participants" :colors="collect($this->segments)->pluck('color')->toArray()" :error="$error" />
                </div>
